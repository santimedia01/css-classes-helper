...
const PrimeFlexClasses: KeyValueStringObject = {
  ...
  ...divider(`col-${v}`, `flex: 0 0 auto; padding: ${PrimeFlexConfig.gridSystem.gutter}; width: ${v}%;`, {
    dividend: 100,
    divisor: 12,
    hasToHaveZero: false,
  }),
  ...
  ...steps(`border-${v}`, `border-width: ${v}px;`, {
    from: PrimeFlexConfig.generators.borderSize.from,
    to: PrimeFlexConfig.generators.borderSize.to,
    step: PrimeFlexConfig.generators.borderSize.step,
  }),
  ...steps(`border-x-${v}`, `border-right-width: ${v}px; border-left-width: ${v}px;`, {
    from: PrimeFlexConfig.generators.borderSize.from,
    to: PrimeFlexConfig.generators.borderSize.to,
    step: PrimeFlexConfig.generators.borderSize.step,
  }),
  ...steps(`border-y-${v}`, `border-top-width: ${v}px; border-bottom-width: ${v}px;`, {
    from: PrimeFlexConfig.generators.borderSize.from,
    to: PrimeFlexConfig.generators.borderSize.to,
    step: PrimeFlexConfig.generators.borderSize.step,
  }),
  ...steps(`border-top-${v}`, `border-top-width: ${v}px;`, {
    from: PrimeFlexConfig.generators.borderSize.from,
    to: PrimeFlexConfig.generators.borderSize.to,
    step: PrimeFlexConfig.generators.borderSize.step,
  }),
  ...steps(`border-left-${v}`, `border-left-width: ${v}px;`, {
    from: PrimeFlexConfig.generators.borderSize.from,
    to: PrimeFlexConfig.generators.borderSize.to,
    step: PrimeFlexConfig.generators.borderSize.step,
  }),
  ...steps(`border-bottom-${v}`, `border-bottom-width: ${v}px;`, {
    from: PrimeFlexConfig.generators.borderSize.from,
    to: PrimeFlexConfig.generators.borderSize.to,
    step: PrimeFlexConfig.generators.borderSize.step,
  }),
  ...steps(`border-right-${v}`, `border-right-width: ${v}px;`, {
    from: PrimeFlexConfig.generators.borderSize.from,
    to: PrimeFlexConfig.generators.borderSize.to,
    step: PrimeFlexConfig.generators.borderSize.step,
  }),
  ...
  ...values(
    `p-${v}`,
    `padding: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `pt-${v}`,
    `padding-top: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `pr-${v}`,
    `padding-right: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `pb-${v}`,
    `padding-bottom: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `pl-${v}`,
    `padding-left: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `px-${v}`,
    `padding-left: ${v}${PrimeFlexConfig.generators.spacing.unit}; padding-right: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `py-${v}`,
    `padding-top: ${v}${PrimeFlexConfig.generators.spacing.unit}; padding-bottom: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...
  ...values(
    `m-${v}`,
    `margin: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `mt-${v}`,
    `margin-top: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `mr-${v}`,
    `margin-right: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `mb-${v}`,
    `margin-bottom: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `ml-${v}`,
    `margin-left: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `mx-${v}`,
    `margin-left: ${v}${PrimeFlexConfig.generators.spacing.unit}; margin-right: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...values(
    `my-${v}`,
    `margin-top: ${v}${PrimeFlexConfig.generators.spacing.unit}; margin-bottom: ${v}${PrimeFlexConfig.generators.spacing.unit};`,
    PrimeFlexConfig.generators.spacing.values,
  ),
  ...
  ...steps(`transition-duration-${v}`, `transition-duration: ${v}${PrimeFlexConfig.generators.transitions.unit};`, {
    from: PrimeFlexConfig.generators.transitions.durations[0].from,
    to: PrimeFlexConfig.generators.transitions.durations[0].to,
    step: PrimeFlexConfig.generators.transitions.durations[0].step,
  }),
  ...steps(`transition-duration-${v}`, `transition-duration: ${v}${PrimeFlexConfig.generators.transitions.unit};`, {
    from: PrimeFlexConfig.generators.transitions.durations[1].from,
    to: PrimeFlexConfig.generators.transitions.durations[1].to,
    step: PrimeFlexConfig.generators.transitions.durations[1].step,
  }),
  ...
  ...steps(`transition-delay-${v}`, `transition-delay: ${v}${PrimeFlexConfig.generators.transitions.unit};`, {
    from: PrimeFlexConfig.generators.transitions.durations[0].from,
    to: PrimeFlexConfig.generators.transitions.delays[0].to,
    step: PrimeFlexConfig.generators.transitions.delays[0].step,
  }),
  ...steps(`transition-delay-${v}`, `transition-delay: ${v}${PrimeFlexConfig.generators.transitions.unit};`, {
    from: PrimeFlexConfig.generators.transitions.delays[1].from,
    to: PrimeFlexConfig.generators.transitions.delays[1].to,
    step: PrimeFlexConfig.generators.transitions.delays[1].step,
  }),
  ...
  slidedown:
    'animation: slidedown .45s ease-in-out; @keyframes slidedown { 0 % { max- height: 0; } 100 % { max- height: auto; } }',
  slideup:
    'animation: slideup .45s cubic-bezier(0, 1, 0, 1); @keyframes slideup { 0% { max-height: 1000px; } 100% { max-height: 0; } }',
  scalein:
    'animation: scalein .15s linear; @keyframes scalein { 0% { opacity: 0; transform: scaleY(0.8); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: scaleY(1); } }',
  fadeinleft:
    'animation: fadeinleft .15s linear; @keyframes fadeinleft { 0% { opacity: 0; transform: translateX(-100%); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: translateX(0%); } }',
  fadeoutleft:
    'animation: fadeoutleft .15s linear; @keyframes fadeoutleft { 0% { opacity: 0; transform: translateX(0%); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: translateX(-100%); } }',
  fadeinright:
    'animation: fadeinright .15s linear; @keyframes fadeinright { 0% { opacity: 0; transform: translateX(100%); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: translateX(0%); } }',
  fadeoutright:
    'animation: fadeoutright .15s linear; @keyframes fadeoutright { 0% { opacity: 0; transform: translateX(0%); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: translateX(100%); } }',
  fadeinup:
    'animation: fadeinup .15s linear; @keyframes fadeinup { 0% { opacity: 0; transform: translateY(-100%); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: translateY(0%); } }',
  fadeoutup:
    'animation: fadeoutup .15s linear; @keyframes fadeoutup { 0% { opacity: 0; transform: translateY(0%); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: translateY(-100%); } }',
  fadeindown:
    'animation: fadeindown .15s linear; @keyframes fadeindown { 0% { opacity: 0; transform: translateY(100%); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: translateY(0%); } }',
  fadeoutdown:
    'animation: fadeoutdown .15s linear; @keyframes fadeoutdown { 0% { opacity: 0; transform: translateY(0%); transition: transform .12s cubic-bezier(0, 0, 0.2, 1), opacity .12s cubic-bezier(0, 0, 0.2, 1); } 100% { opacity: 1; transform: translateY(100%); } }',
  'animate-width':
    'animation: animate-width 1000ms linear; @keyframes animate-width { 0% { width: 0; } 100% { width: 100%; } }',

  // PrimeFlex ANIMATION - Animation Duration - Docs: https://www.primefaces.org/primeflex/animationduration
  ...steps(`animation-duration-${v}`, `animation-duration: ${v}${PrimeFlexConfig.generators.animations.unit};`, {
    from: PrimeFlexConfig.generators.animations.durations[0].from,
    to: PrimeFlexConfig.generators.animations.durations[0].to,
    step: PrimeFlexConfig.generators.animations.durations[0].step,
  }),
  ...steps(`animation-duration-${v}`, `animation-duration: ${v}${PrimeFlexConfig.generators.animations.unit};`, {
    from: PrimeFlexConfig.generators.animations.durations[1].from,
    to: PrimeFlexConfig.generators.animations.durations[1].to,
    step: PrimeFlexConfig.generators.animations.durations[1].step,
  }),

  // PrimeFlex ANIMATION - Animation Delay - Docs: https://www.primefaces.org/primeflex/animationdelay
  ...steps(`animation-delay-${v}`, `animation-delay: ${v}${PrimeFlexConfig.generators.animations.unit};`, {
    from: PrimeFlexConfig.generators.animations.delays[0].from,
    to: PrimeFlexConfig.generators.animations.delays[0].to,
    step: PrimeFlexConfig.generators.animations.delays[0].step,
  }),
  ...steps(`animation-delay-${v}`, `animation-delay: ${v}${PrimeFlexConfig.generators.animations.unit};`, {
    from: PrimeFlexConfig.generators.animations.delays[1].from,
    to: PrimeFlexConfig.generators.animations.delays[1].to,
    step: PrimeFlexConfig.generators.animations.delays[1].step,
  }),
